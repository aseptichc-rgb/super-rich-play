...
// cycle and speculative names swing wildly. `beta` scales a market crash, `shares` sets market cap.
...
export const STOCKS=[
 ...
 {id:'tech',name:L('Next Tech'),sector:L('Software'),type:'growth',base:160,risk:.12,annualRate:.30,yield:0,beta:1.4,shares:40000000},
 {id:'estate',name:L('River REIT'),sector:L('Real estate'),type:'dividend',base:80,risk:.04,annualRate:.08,yield:.07,beta:.8,shares:40000000},
 {id:'bank',name:L('Harbor Bank'),sector:L('Finance'),type:'dividend',base:60,risk:.05,annualRate:.09,yield:.06,beta:1,shares:60000000},
 {id:'power',name:L('Riverside Power'),sector:L('Utilities'),type:'defensive',base:120,risk:.03,annualRate:.07,yield:.05,beta:.4,shares:40000000},
 {id:'ship',name:L('Blue Dock Shipping'),sector:L('Shipping'),type:'cyclical',base:45,risk:.10,annualRate:.15,yield:.02,beta:1.3,shares:25000000},
 ...
 {id:'bio',name:L('Helix Bio'),sector:L('Biotech'),type:'speculative',base:30,risk:.20,annualRate:.25,yield:0,beta:1.8,shares:15000000},
 {id:'game',name:L('Pixel Forge'),sector:L('Games'),type:'growth',base:50,risk:.14,annualRate:.32,yield:0,beta:1.5,shares:30000000},
 {id:'solar',name:L('Solar Fields'),sector:L('Clean energy'),type:'growth',base:35,risk:.15,annualRate:.28,yield:0,beta:1.6,shares:25000000}
];
...
const ALL=new Map([...STOCKS,...IPO_POOL].map((k,n)=>[k.id,{...k,key:n}]));
