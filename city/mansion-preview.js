...
export function mansionSitePreview(d,{area,color,styleName}){
 ...
 const names={pool:'수영장',garden:'조경 정원',cinema:'영화관',golf:'골프 코스',spa:'웰니스 스파',helipad:'헬리패드'};
